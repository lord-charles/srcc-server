...
export class ContractTemplate extends Document {
  ...
  @ApiProperty({
    example: 'html',
    description:
      'Content type of the template (e.g., html, markdown, text, json)',
  })
  ...
  @ApiProperty({
    description:
      'Raw template content. Can be HTML/Markdown/Text or JSON string.',
  })
  @Prop({ required: true })
  content: string;

  @ApiProperty({
    description: 'Optional list of variable keys used in the template',
  })
