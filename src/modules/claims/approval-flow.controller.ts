...
export class ApprovalFlowController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Create or update an approval flow',
    description: 'Creates or updates an approval flow for a department.',
  })
  @ApiBody({ type: ApprovalFlow, required: true })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: 'Approval flow created or updated successfully.',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Invalid approval flow data.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Deletes an approval flow by its ID.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns all approval flows.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Array of approval flows.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a specific approval flow by MongoDB ID.',
  })
  @ApiParam({ name: 'id', description: 'Approval flow MongoDB ID' })
